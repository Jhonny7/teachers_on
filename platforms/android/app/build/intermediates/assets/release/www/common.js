...
var CategoriaModel = /** @class */ (function () {
    function CategoriaModel(id, descripcion, img_url, img_base64, color) {
        this.id = id;
...
/***/ "./src/services/external-url-service/external-url.service.ts":
/*!*******************************************************************!*\
  !*** ./src/services/external-url-service/external-url.service.ts ***!
  \*******************************************************************/
/*! exports provided: ExternalUrlService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExternalUrlService", function() { return ExternalUrlService; });
...
var ExternalUrlService = /** @class */ (function () {
    function ExternalUrlService(iab) {
        this.iab = iab;
    }
    ExternalUrlService.prototype.openUrl = function (url) {
    ...
    ExternalUrlService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
